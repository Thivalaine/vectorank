...
<body>
    <div class="container">
        ...
        if ($matchResult->num_rows > 0) {
            ...
            $player1Query = "SELECT id, name, mmr, is_anonymized FROM players WHERE id = $player1_id";
            $player2Query = "SELECT id, name, mmr, is_anonymized FROM players WHERE id = $player2_id";
            ...
            if ($player1Result->num_rows > 0 && $player2Result->num_rows > 0) {
                ...
                $player1Name = $player1Data['is_anonymized'] ? 'Anonyme' : $player1Data['name'];
                $player2Name = $player2Data['is_anonymized'] ? 'Anonyme' : $player2Data['name'];

                $current_mmr1 = $player1Data['is_anonymized'] ? 'Anonyme' : $player1Data['mmr'];
                $current_mmr2 = $player2Data['is_anonymized'] ? 'Anonyme' : $player2Data['mmr'];
                ...
                $mmr_after_adjustment1 = $player1Data['is_anonymized'] ? 'Anonyme' : ($current_mmr1 + $adjustment_player1);
                $mmr_after_adjustment2 = $player2Data['is_anonymized'] ? 'Anonyme' : ($current_mmr2 + $adjustment_player2);
