...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            ...
            <form action="add_match_double_action.php" method="post" id="matchForm">
                <div id="match-forms-container">
                    <!-- Premier Formulaire de Match (Non-amovible) -->
                    <div class="match-form">
                        <h2>Match 1</h2>
                        <!-- Joueurs de l'équipe 1 -->
                        <div class="form-group">
                            <label for="team1_player1">Joueur 1 de l'équipe 1</label>
                            <select class="form-control" id="team1_player1" name="team1_player1[]" required>
                                <?php
                                include 'db.php';
                        ...
                        <div class="form-group">
                            <label for="team1_player2">Joueur 2 de l'équipe 1</label>
                            <select class="form-control" id="team1_player2" name="team1_player2[]" required>
                                <?php
                        ...
                        <div class="form-group">
                            <label for="team2_player1">Joueur 1 de l'équipe 2</label>
                            <select class="form-control" id="team2_player1" name="team2_player1[]" required>
                                <?php
                                $result->data_seek(0); // Remise à zéro du pointeur de résultats
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='{$row['id']}'>{$row['name']}</option>";
                        ...
                        <div class="form-group">
                            <label for="team2_player2">Joueur 2 de l'équipe 2</label>
                            <select class="form-control" id="team2_player2" name="team2_player2[]" required>
                                <?php
                                $result->data_seek(0); // Remise à zéro du pointeur de résultats
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='{$row['id']}'>{$row['name']}</option>";
...
function populateMatchForm(matchForm, matchData) {
    matchForm.querySelector('[name="team1_player1[]"]').value = matchData.team1_player1;
    matchForm.querySelector('[name="team1_player2[]"]').value = matchData.team1_player2;
    matchForm.querySelector('[name="team2_player1[]"]').value = matchData.team2_player1;
    matchForm.querySelector('[name="team2_player2[]"]').value = matchData.team2_player2;
    matchForm.querySelector('[name="team1_score[]"]').value = matchData.team1_score;
    matchForm.querySelector('[name="team2_score[]"]').value = matchData.team2_score;
...
function saveMatchesToLocalStorage() {
    ...
    document.querySelectorAll('.match-form').forEach((matchForm, index) => {
        let matchData = {
            team1_player1: matchForm.querySelector('[name="team1_player1[]"]').value,
            team1_player2: matchForm.querySelector('[name="team1_player2[]"]').value,
            team2_player1: matchForm.querySelector('[name="team2_player1[]"]').value,
            team2_player2: matchForm.querySelector('[name="team2_player2[]"]').value,
            team1_score: matchForm.querySelector('[name="team1_score[]"]').value,
            team2_score: matchForm.querySelector('[name="team2_score[]"]').value,
